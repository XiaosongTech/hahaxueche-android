...
public class WebViewUrl {
    ...
    public static final String WEB_URL_ZHENGCE = BuildConfig.MOBILE_URL + "/share/jia-kao-xin-zheng";
    ...
    public static final String WEB_URL_ARTICLES = BuildConfig.MOBILE_URL + "/wenzhang";
}
