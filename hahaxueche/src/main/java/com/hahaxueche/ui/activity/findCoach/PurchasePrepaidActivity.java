...
import com.hahaxueche.presenter.findCoach.PurchasePrepaidPresenter;
...
public class PurchasePrepaidActivity extends HHBaseActivity implements PurchasePrepaidView {
    private PurchasePrepaidPresenter mPresenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPresenter = new PurchasePrepaidPresenter();
        setContentView(R.layout.activity_purchase_prepaid);
    ...
    private void initActionBar() {
        ...
        mTvTitle.setText("预付定金");
        mIvBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                PurchasePrepaidActivity.this.finish();
            }
        });
    }
        ...
        if (requestCode == Pingpp.REQUEST_CODE_PAYMENT) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                if (result.equals("success")) {
                    mPresenter.getStudentUtilPrepaid();
