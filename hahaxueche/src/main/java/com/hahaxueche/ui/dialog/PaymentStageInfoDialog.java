...
public class PaymentStageInfoDialog extends Dialog {
    ...
    private void loadDatas() {
        ...
        if (mIsPaid) {
            ...
            ivPsInfo.setImageDrawable(mContext.getResources().getDrawable(R.drawable.ic_havenotpay));
            tvPsInfoTitle.setText(mPaymentStageName + "待打款");
            tvPsInfoTitle.setTextColor(mContext.getResources().getColor(R.color.app_theme_color));
        }
    }
