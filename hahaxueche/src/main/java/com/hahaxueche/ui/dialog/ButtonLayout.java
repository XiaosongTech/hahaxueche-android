...
public class ButtonLayout extends LinearLayout implements View.OnClickListener {
    ...
    private void init(Context context) {
        ...
        setPadding(Util.instence(context).dip2px(8), 0, Util.instence(context).dip2px(8), Util.instence(context).dip2px(8));
    }
    ...
    private void addDivideLine(LinearLayout layout) {
        ...
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(
                ViewGroup.LayoutParams.MATCH_PARENT, Util.instence(context).dip2px(1));
    ...
    private void addCancelButton() {
        Button button = addButton(this, getResources().getString(R.string.user_registe_cancel_photo), R.color.coach_info_blue);
