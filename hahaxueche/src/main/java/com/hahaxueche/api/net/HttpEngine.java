...
public class HttpEngine {
    private final static String TAG = "gibxin";
    /**
     * prod -> http://api.hahaxueche.net
     * staging -> http://staging-api.hahaxueche.net
     * preprod -> http://preprod-api.hahaxueche.net
     */
    private static boolean isDebug = false;
    private boolean isShowLog = false;
    public final static String BASE_SERVER_IP = isDebug ? "https://staging-api.hahaxueche.net" : "https://api.hahaxueche.net";
